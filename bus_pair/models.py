...
class BusPair(models.Model):
    ...
    departure_bus_stop = models.ForeignKey(Busstop, db_constraint=False, verbose_name='出発バス停', on_delete=models.PROTECT, related_name="departure_bus_stop")
    arrival_bus_stop = models.ForeignKey(Busstop, db_constraint=False,verbose_name='到着バス停', on_delete=models.PROTECT, related_name="arrival_bus_stop")
