...
class BusPairSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BusPair
        fields = ['id', 'departure_bus_stop', 'arrival_bus_stop', 'departure_bus_stop_id', 'arrival_bus_stop_id' ]


    def create(self, validated_data: Dict[str, Any]) -> BusPair:
        validated_data['departure_bus_stop'] = validated_data.get('departure_bus_stop_id', None)
        validated_data['arrival_bus_stop'] = validated_data.get('arrival_bus_stop_id', None)
